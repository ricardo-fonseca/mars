...
public class MipsXray extends AbstractMarsToolAndApplication{
    ...
    */
    ...
    protected void processMIPSUpdate(Observable resource, AccessNotice notice) {
        ...
        System.out.println("(*zamb*) In processMIPSUpdate()");
        ...
        if (currentAdress == lastAddress) {
            System.out.println("(*zamb*) currentAddress == lastAddress ");
            return;
        }
        ...
        try {
            ...
            System.out.println("(*zamb*) Calling stmt.getInstruction()");
        ...
        System.out.println("(*zamb*) Finished processMIPSUpdate()");
    ...
    implements ActionListener, MouseListener {
        ...
        */
        ...
        {
            System.out.println("new DatapathAnimation:" + instructionBinary ); 
            ...
            System.out.println("DatapathAnimation finished" ); 
        ...
        public void setUpInstructionInfo( Graphics2D g2d){
            ...
            Font fontTitle = new Font(Font.SANS_SERIF, Font.PLAIN, 10);
            ...
            if(instructionCode.substring(0,6).equals("000000")){  //R-type instructions description on screen definition.		 
                textVariable = new TextLayout("REGISTER TYPE INSTRUCTION", new Font(Font.SANS_SERIF, Font.BOLD, 25), frc);
                ...
                textVariable = new TextLayout("JUMP TYPE INSTRUCTION", new Font(Font.SANS_SERIF, Font.BOLD, 25), frc); //description of instruction code type for jump.
                g2d.setColor(Color.black);
                textVariable.draw(g2d, 280, 30);
                ...
                textVariable = new TextLayout("LOAD TYPE INSTRUCTION", new Font(Font.SANS_SERIF, Font.BOLD, 25), frc); //description of instruction code type for load.
                g2d.setColor(Color.black);
                textVariable.draw(g2d, 280, 30);
                //opcode label
                textVariable = new TextLayout("opcode", fontTitle, frc);
                ...
                textVariable = new TextLayout("STORE TYPE INSTRUCTION", new Font(Font.SANS_SERIF, Font.BOLD, 25), frc);
                g2d.setColor(Color.black);
                textVariable.draw(g2d, 280, 30);
                //opcode label
                textVariable = new TextLayout("opcode", fontTitle, frc);
                ...
                textVariable = new TextLayout("BRANCH TYPE INSTRUCTION",new Font(Font.SANS_SERIF, Font.BOLD, 25), frc);
                g2d.setColor(Color.black);
                ...
                textVariable = new TextLayout("IMMEDIATE TYPE INSTRUCTION",new Font(Font.SANS_SERIF, Font.BOLD, 25), frc);
                g2d.setColor(Color.black);
                textVariable.draw(g2d, 250, 30);
        ...
        public void startAnimation(String codeInstruction){
            System.out.println("(*zamb*) startAnimation(): " + codeInstruction);
        ...
        { 
            System.out.println("(*zamb*) actionPerformed(), justStarted: " + justStarted);
            if (justStarted)   
                justStarted = false;
            if(xIsMoving)
                indexX++;
        ...
        public void printTextDtoU(Vertex v){	 
            ...
            TextLayout actionInFunctionalBlock = new TextLayout(v.getName(), new Font(Font.SANS_SERIF, Font.BOLD, 13), frc);
            g2d.setColor(Color.RED);
            ...
            &&!instructionCode.substring(0,6).matches("00001[0-1]")){//load instruction
                actionInFunctionalBlock = new TextLayout(" ", new Font(Font.SANS_SERIF, Font.BOLD, 13), frc);
            }
            if(v.getName().equals("ALUVALUE")){
                if( instructionCode.substring(0,6).equals("000000"))//R-type instruction
                actionInFunctionalBlock = new TextLayout(functionEquivalenceTable.get(instructionCode.substring(26,32)), new Font(Font.SANS_SERIF, Font.BOLD, 13), frc);
                else //other instructions 
                actionInFunctionalBlock  = new TextLayout(opcodeEquivalenceTable.get(instructionCode.substring(0,6)), new Font(Font.SANS_SERIF, Font.BOLD, 13), frc);
            }
            
            if(instructionCode.substring(0,6).matches("0001[0-1][0-1]")&& v.getName().equals("CP+4")) //branch code
            actionInFunctionalBlock = new TextLayout("PC+OFFSET", new Font(Font.SANS_SERIF, Font.BOLD, 13), frc);
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            PointerInfo a = MouseInfo.getPointerInfo();
            System.out.println("In mouseClicker()");
